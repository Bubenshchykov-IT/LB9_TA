...
Feature: Login
  ...
  Scenario Outline: Successful login using valid credentials
    ...
    Examples:
      ...
      |	danbuben2000@gmail.com			|	10052000Dan!	        |
  ...
  Scenario Outline: Failed login using wrong credentials
    ...
    Examples:
      ...
      | Danbuben2000@gmail.com         | 10052000Dan!	         | Sign in failed! |
      | danbuben2000@gmail.com	       | 10052000Dan	         | Sign in failed! |
      | dnbuben2000@gmail.com          | 10052000Dan!	         | Sign in failed! |
      | dnbuben2000@gmail.com          | 10052000                | Sign in failed! |
