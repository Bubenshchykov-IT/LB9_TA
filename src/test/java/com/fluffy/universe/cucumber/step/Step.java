...
public class Step {
    ...
    public void iAmARegisteredUser() {
        System.setProperty("webdriver.chrome.driver", "C:\\MainProject\\chromedriver_win32\\chromedriver.exe");
    ...
    public void iAmALoggedInUser() {
        ...
        driver.findElement(By.id("sign-in__password")).sendKeys("1052000Dan!");
